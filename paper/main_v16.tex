...
\setlength{\floatsep}{9pt plus 2pt minus 2pt}\setlength{\textfloatsep}{10pt plus 2pt minus 3pt}\setlength{\dblfloatsep}{9pt plus 2pt minus 2pt}\setlength{\dbltextfloatsep}{10pt plus 2pt minus 3pt}
...
\noindent\textbf{Scope.} A vote over views removes disagreement that varies by view and inherits whatever is constant across views, such as the class-share difference of Section~\ref{sec:limits}; Section~\ref{sec:pairs} scores each pair.
