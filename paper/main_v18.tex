...
\label{sec:limits}
The vote does not bring class shares closer to the tests: the shot:whisky ratio is \RatioRawTrain{} in raw labels and \RatioSceneTrain{} after it, against \RatioManualStd{} and \RatioManualOOD{} in the tests. Decoding the chains under the confusion of Table~\ref{tab:conf} moves the ratio no closer; separating the labeller's contribution from the staging's needs the per-box height, which the release omits.
